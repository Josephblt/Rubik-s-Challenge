...
{
    public class BackLayer : AbstractLayer
    {
        #region Constructor

        public BackLayer()
        {
            position[0] = new Point3D(0, 0, 0);
            position[1] = new Point3D(1, 0, 0);
            position[2] = new Point3D(2, 0, 0);
            position[3] = new Point3D(2, 1, 0);
            position[4] = new Point3D(2, 2, 0);
            position[5] = new Point3D(1, 2, 0);
            position[6] = new Point3D(0, 2, 0);
            position[7] = new Point3D(0, 1, 0);

            this.MiddlePosition = new Point3D(1, 1, 0);
        }
